                                ...
                                <div className="space-y-2">
                                    ...
                                    <select
                                        ...
                                        onChange={(e) => {
                                            ...
                                            // Only auto-fill if phone is empty OR if it starts with the OLD calling code
                                            // If the admin is editing, it's safe to overwrite if they change country
                                            setFormData({ ...formData, country: countryName, city: '', phoneNumber: code });
